...
RCT_EXPORT_VIEW_PROPERTY(skipSslErrors, BOOL)
...
RCT_CUSTOM_VIEW_PROPERTY(skipSslErrors, BOOL, RNCWebView) {
    view.skipSslErrors = json == nil ? false : [RCTConvert BOOL: json];
}
